...
- The API: [https://coders-network-api.onrender.com/](https://coders-network-api.onrender.com/)
...
- HTTPie:
  ...
  `http -v POST https://coders-network-api.onrender.com/signup name="Kelley van Evert" email=kelley@codaisseur.com password=abcd`
...
- HTTPie:
  ...
  `http -v POST https://coders-network-api.onrender.com/login email=kelley@codaisseur.com password=abcd`
